        ...
        completion = client.chat.completions.create(
            ...
            messages=[
                ...
                },
                {
                    ...
                    - if resume does not mention a degree like bachelor, master, or PhD (or any of them in japanese), or only mentions associate's degree and/or high school diploma: "Candidate may not have university degree. Highest education listed is [highest education listed]."
